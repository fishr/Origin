...
#define SENSORS_I2C_SCL_GPIO_CLK          RCC_AHB1Periph_GPIOA
#define SENSORS_I2C_SCL_GPIO_PIN          GPIO_Pin_8
#define SENSORS_I2C_SCL_GPIO_PINSOURCE    GPIO_PinSource8
 
#define SENSORS_I2C_SDA_GPIO_PORT         GPIOC
#define SENSORS_I2C_SDA_GPIO_CLK          RCC_AHB1Periph_GPIOC
#define SENSORS_I2C_SDA_GPIO_PIN          GPIO_Pin_9
#define SENSORS_I2C_SDA_GPIO_PINSOURCE    GPIO_PinSource9

#define SENSORS_I2C_RCC_CLK               RCC_APB1Periph_I2C3
#define SENSORS_I2C_AF                    GPIO_AF_I2C3
